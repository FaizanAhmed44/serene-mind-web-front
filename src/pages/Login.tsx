...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col lg:flex-row animate-fade-in">
      ...
      <div className="lg:w-1/2 w-full min-h-[40vh] lg:min-h-screen bg-gradient-to-br from-primary via-primary/90 to-secondary relative overflow-hidden flex items-center justify-center p-6 sm:p-8 lg:p-12 animate-slide-in-left">
        {/* Background Pattern */}
